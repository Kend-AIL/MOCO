...
class RealValCNNLineDetNew(nn.Module):
    ...
    """
    def __init__(self, activation="relu", input_dim=2, input_size=[12, 128, 128],
                 crop_readout=False, output_size=[1, 128], first_filters=64, last_filters=False,
                 kernel_size=3, num_layer=5, dropout=False, use_bias=True,
